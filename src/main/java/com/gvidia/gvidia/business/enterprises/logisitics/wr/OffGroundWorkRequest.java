 ...
 */
public class OffGroundWorkRequest extends WorkRequest implements TableSerializable{
    ...
    public OffGroundWorkRequest(Shipment mShipment, DeliveryMan mDeliveryMan, WorkRequest mShipmentRequest) {
    ...
    public WorkRequest getmShipmentRequest() {
        return mShipmentRequest;
    }

    public static OffGroundWorkRequest createOffGroundWorkRequest(Shipment  s, WorkRequest sourceMaterialWorkRequest) {
        return new OffGroundWorkRequest(s, null, sourceMaterialWorkRequest);
    }
