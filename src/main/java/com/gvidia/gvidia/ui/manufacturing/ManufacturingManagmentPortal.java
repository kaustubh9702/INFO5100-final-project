...
import com.gvidia.gvidia.ui.retailer.*;
...
import com.gvidia.gvidia.ui.panels.AnalysisPanel;
 ...
 * @author MyPC1
 */
public class ManufacturingManagmentPortal extends javax.swing.JPanel {
    ...
    Colors color;
    public ManufacturingManagmentPortal(Controller cont,Employee emp) {
        
        mEcosystem = cont.getmEcoSystem();
        this.mManufacturer = mEcosystem.getmManufacturer();
    ...
    private void initComponents() {
        ...
        iconButton1 = new IconButton("inventory.png", "Inv Manager");
        iconButton2 = new IconButton("dev.png", "Developers");
        iconButton3 = new IconButton("purchaser.png", "Purchaser");
        iconButton4 = new IconButton("analytics.png", "Analytics");
        ...
        side_pane.add(iconButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, -1, -1));
        ...
        side_pane.add(iconButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 230, -1, -1));
        ...
        side_pane.add(iconButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, -1, -1));
        ...
        side_pane.add(iconButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 330, -1, -1));
    ...
    private void iconButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton1MousePressed
        ...
        resetColor(new IconButton[]{iconButton3, iconButton2, iconButton4});
        changeWorkContainerPanel(InventoryManTable);
    ...
    private void iconButton2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton2MousePressed
        ...
        resetColor(new IconButton[]{iconButton3, iconButton1, iconButton4});
        changeWorkContainerPanel(DevTable);
    ...
    private void iconButton3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton3MousePressed
        ...
        resetColor(new IconButton[]{iconButton1, iconButton2, iconButton4});
        changeWorkContainerPanel(PurchaserTables);
    ...
    private void iconButton4MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton4MousePressed
        ...
        resetColor(new IconButton[]{iconButton1, iconButton2, iconButton3});
        try {
            changeWorkContainerPanel(new AnalysisPanel(mManufacturer.getInsights()));
        } catch (IOException ex) {
            Logger.getLogger(ManufacturingManagmentPortal.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public DisplayTable DevTable;
    public DisplayTable PurchaserTables;
    public DisplayTable InventoryManTable;
    ...
    public void loadPanels(){
        ...
        DevTable =  new DisplayTable<UserAccount>(
            mEcosystem.getUserAccountDirectory().fliter(ProductDevelopmentOrganisation.class.toString()),
                "Product Developers",
                 Arrays.asList(new ElementButton<UserAccount>("Create", "create.png", new ActionInterface<UserAccount>() {
                    ...
                    public void action(UserAccount t) {
                            changeWorkContainerPanel(new UserAccountPanel(null,mManufacturer,mManufacturer.getProductDevOrganisation(), true));                
                    }
                }),
                new ElementButton<UserAccount>("Edit", "edit.png", new ActionInterface<UserAccount>() {
                    @Override
                    public void action(UserAccount t) {
                        changeWorkContainerPanel(new UserAccountPanel(t,mManufacturer,mManufacturer.getProductDevOrganisation(), false));
                    }
                }),
        ...
        PurchaserTables =  new DisplayTable<UserAccount>(
            mEcosystem.getUserAccountDirectory().fliter(PurchaseOrganisation.class.toString()),
                "Purchasers",
                 Arrays.asList(new ElementButton<UserAccount>("Create", "create.png", new ActionInterface<UserAccount>() {
                    @Override
                    public void action(UserAccount t) {
                        
                        changeWorkContainerPanel(new UserAccountPanel(null,mManufacturer,mManufacturer.getPurchaseOrganisation(), true));
                ...
                new ElementButton<UserAccount>("Edit", "edit.png", new ActionInterface<UserAccount>() {
                    ...
                    public void action(UserAccount t) {
                        ...
                        changeWorkContainerPanel(new UserAccountPanel(t,mManufacturer,mManufacturer.getPurchaseOrganisation(), false));
                    }
        ...
        InventoryManTable =  new DisplayTable<UserAccount>(
            mEcosystem.getUserAccountDirectory().fliter(InventoryOrganisation.class.toString()),
                "Purchasers",
                 Arrays.asList(new ElementButton<UserAccount>("Create", "create.png", new ActionInterface<UserAccount>() {
                    @Override
                    public void action(UserAccount t) {
                        changeWorkContainerPanel(new UserAccountPanel(null,mManufacturer,mManufacturer.getInventoryOrganisation(), true));
                    }
                }),
                new ElementButton<UserAccount>("Edit", "edit.png", new ActionInterface<UserAccount>() {
                    @Override
                    public void action(UserAccount t) {
                        if(isNullThenShout(t)) return;
                        changeWorkContainerPanel(new UserAccountPanel(t,mManufacturer,mManufacturer.getInventoryOrganisation(), false));
                    }            
                }),
                new ElementButton<UserAccount>("Delete", "delete.png", new ActionInterface<UserAccount>() {
                    @Override
