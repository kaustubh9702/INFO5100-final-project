 ...
 * @author Krishica
 */
public class PurchaserPanel extends javax.swing.JPanel {
    ...
    PurchaseOrganisation mPurchaseOrg;
    UserAccount mAccount;
    
    Colors color;
    public PurchaserPanel(Controller cont,Organization org,UserAccount account, Enterprise ent) {
        
        mEcosystem = cont.getmEcoSystem();
        this.mManufacturer = (ManufacturingEnterprise) ent;
        mPurchaseOrg = this.mManufacturer.getPurchaseOrganisation();
    ...
    private void initComponents() {
        ...
        iconButton3 = new IconButton("shop.png", "Info");
        iconButton1 = new IconButton("incoming.png", "Material");
        iconButton2 = new IconButton("outgoing.png", "Requesents Sent");
    ...
    private void iconButton2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton2MousePressed
        ...
        changeWorkContainerPanel(RawMaterialWorkRequestTable);
    ...
    private void iconButton3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton3MousePressed
        ...
        changeWorkContainerPanel(new UserAccountPanel(mAccount, mManufacturer, mPurchaseOrg, false));
    ...
    public DisplayTable RawMaterialWorkRequestTable;
    ...
    public void loadPanels(){
        ...
        MaterialWorkRequestTable =  new DisplayTable<RawMaterialWorkRequest>(
            mPurchaseOrg.getmMaterialRequests().getList(),
                "Incoming Material Request",
                 Arrays.asList( null,
                new ElementButton<RawMaterialWorkRequest>("Purchase", "cart.png", new ActionInterface<RawMaterialWorkRequest>() {
                    @Override
                    public void action(RawMaterialWorkRequest t) {
                        if(isNullThenShout(t)) return;
                        mEcosystem.getmSupplier().sourceMaterial(t, mAccount);
                        mPurchaseOrg.getmRawMaterialWorkRequests().add(t);
                        JOptionPane.showMessageDialog(jSplitPane1, "Request Sent to Supplier");
                    }
                }),
                new ElementButton<RawMaterialWorkRequest>("Reject", "cancel.png", new ActionInterface<RawMaterialWorkRequest>() {
                    @Override
                    public void action(RawMaterialWorkRequest c) {
                        if(isNullThenShout(c)) return;
                        c.setStatus(WorkRequest.Status.REJECTED);
                        JOptionPane.showMessageDialog(jSplitPane1, "Request Rejected :(");
                    }
                })
              ),
        ...
        RawMaterialWorkRequestTable =  new DisplayTable<RawMaterialWorkRequest>(
                mPurchaseOrg.getmRawMaterialWorkRequests().getList(),
                "Material Requested",
