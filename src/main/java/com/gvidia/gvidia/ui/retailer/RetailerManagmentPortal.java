 ...
 * @author MyPC1
 */
public class RetailerManagmentPortal extends javax.swing.JPanel {
    ...
    Colors color;
    public RetailerManagmentPortal(Controller cont,Employee emp) {
        
        mEcosystem = cont.getmEcoSystem();
        this.mRetailer = mEcosystem.getmRetailer();
    ...
    private void initComponents() {
        ...
        iconButton1 = new IconButton("customer.png", "Customers");
        iconButton2 = new IconButton("union_32px.png", "Procurer");
    ...
    private void iconButton2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton2MousePressed
        ...
        changeWorkContainerPanel(InvManTable);
    ...
    private void iconButton3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton3MousePressed
        ...
        try {
            changeWorkContainerPanel(new AnalysisPanel(mRetailer.getInsights()));
        } catch (IOException ex) {
            Logger.getLogger(RetailerManagmentPortal.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public DisplayTable InvManTable;
    ...
    public void loadPanels(){
        ...
        CustomerTable =  new DisplayTable<Customer>(
            mRetailer.getCustomerDirectory().getList(),
                "Customers",
                 Arrays.asList(new ElementButton<Customer>("Create", "create.png", new ActionInterface<Customer>() {
                    @Override
                    public void action(Customer t) {
                            changeWorkContainerPanel(new CustomerInfoPanel(null,mRetailer,mRetailer.getSalesOrganisation(), true));                
                    }
                }),
                new ElementButton<Customer>("Edit", "edit.png", new ActionInterface<Customer>() {
                    @Override
                    public void action(Customer t) {
                        changeWorkContainerPanel(new CustomerInfoPanel(t,mRetailer,mRetailer.getSalesOrganisation(), false));
                    }
                }),
        ...
        InvManTable =  new DisplayTable<UserAccount>(
            mEcosystem.getUserAccountDirectory().fliter(ProcurementOrganisation.class.toString()),
                "Procurers",
                 Arrays.asList(new ElementButton<UserAccount>("Create", "create.png", new ActionInterface<UserAccount>() {
                    ...
                    public void action(UserAccount t) {
                        ...
                        changeWorkContainerPanel(new UserAccountPanel(t,mRetailer,mRetailer.getProcurementOrganisation(), false));
