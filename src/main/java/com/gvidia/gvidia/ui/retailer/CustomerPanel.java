...
public class CustomerPanel extends javax.swing.JPanel {
    ...
    SalesOrganisation mSalesOrg;
    UserAccount mAccount;
    Customer mCustomer;
    Colors color;

    public CustomerPanel(Controller cont,Organization org,UserAccount account, Enterprise ent) {
        
        mEcosystem = cont.getmEcoSystem();
        this.mRetailer = (RetailerEnterprise) ent;
        mSalesOrg = this.mRetailer.getSalesOrganisation();
        mCustomer = mSalesOrg.getmCustomer(account);
        color = mRetailer.getThemeColor();
        initComponents();
        this.mController=cont;
        mAccount = account;
        loadPanels();
        resetColor(new IconButton[]{iconButton2, iconButton1,  iconButton6, iconButton6});
    ...
    private void initComponents() {
        ...
        iconButton6 = new IconButton("customer.png", "Customer");
        iconButton5 = new IconButton("time.png", "Prev Orders");
        ...
        side_pane.add(iconButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 380, 160, -1));
    ...
    private void iconButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton1MousePressed
        ...
        resetColor(new IconButton[]{iconButton5, iconButton2, iconButton6});
    ...
    private void iconButton2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton2MousePressed
        ...
        resetColor(new IconButton[]{iconButton5, iconButton1,iconButton6});
    ...
    private void iconButton6MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton6MousePressed
        ...
        resetColor(new IconButton[]{iconButton1, iconButton2,iconButton5});
        changeWorkContainerPanel(new CustomerInfoPanel(mCustomer, mRetailer, mSalesOrg, false));
    ...
    private void iconButton5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton5MousePressed
        ...
        resetColor(new IconButton[]{iconButton1, iconButton2,iconButton6});
    ...
    public void loadPanels(){
        ...
        CartTable = new DisplayTable<OrderItem>(mCustomer.getmCart().getmOrderItems(),"Cart",
            Arrays.asList(new ElementButton<OrderItem>("Clear", "clear.png", new ActionInterface<OrderItem>() {
                    @Override
                ...
                new ElementButton<OrderItem>("Delete", "delete.png", new ActionInterface<OrderItem>() {
                    ...
                    public void action(OrderItem i) {
                        ...
                        System.out.println(mCustomer.getmCart()
        ...
        ProductsTable =  new DisplayTable<OrderItem>(
            mRetailer.getProcurementOrganisation().getInventoryList(),
                "Inventory",
                 Arrays.asList(null,null,
                    new ElementButton<OrderItem>("Add", "add.png", new ActionInterface<OrderItem>() {
                        ...
                        public void action(OrderItem c) {
                            ...
                            mCustomer.getmCart().add(c.getmProduct());
        ...
        PrevOrdersTable = new DisplayTable<OrderWorkRequest>(
            mCustomer.getmOrderWorkRequest().getList(),
                "Prev Orders",
                 Arrays.asList(new ElementButton<OrderWorkRequest>("View", "view.png", new ActionInterface<OrderWorkRequest>() {
                        @Override
                        public void action(OrderWorkRequest c) {
                            if(isNullThenShout(c)) return;
                            
                            DisplayTable<OrderItem> orderTable = new DisplayTable<>(
                                    c.getmOrder().getmOrderItems(),
                                    "Order",
