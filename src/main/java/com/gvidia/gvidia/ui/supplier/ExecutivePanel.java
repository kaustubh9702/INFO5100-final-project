 ...
 * @author MyPC1
 */
public class ExecutivePanel extends javax.swing.JPanel {
    ...
    ExecutiveOrganisation mExecutiveOrg;
    UserAccount mAccount;
    
    Colors color;
    public ExecutivePanel(Controller cont,Organization org,UserAccount account, Enterprise ent) {
        
        mEcosystem = cont.getmEcoSystem();
        this.mSupplier =   (SupplierEnterprise) ent;
        mExecutiveOrg = this.mSupplier.getExecutiveOrganisation();
    ...
    private void iconButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton1MousePressed
        ...
        changeWorkContainerPanel(IncomingRequest);
    ...
    private void iconButton3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton3MousePressed
        ...
        changeWorkContainerPanel(new UserAccountPanel(mAccount, mSupplier, mExecutiveOrg, false));
    ...
    public DisplayTable IncomingRequest;
    ...
    public void loadPanels(){
        ...
        IncomingRequest =  new DisplayTable<RawMaterialWorkRequest>(
            mExecutiveOrg.getmRawMaterialRequests().getList(),
                "Incoming Material Request",
                 Arrays.asList( null,
                new ElementButton<RawMaterialWorkRequest>("Source", "tick.png", new ActionInterface<RawMaterialWorkRequest>() {
                    @Override
                    public void action(RawMaterialWorkRequest t) {
                        if(isNullThenShout(t)) return;
                          SourceMaterialWorkRequest sourceMaterialWorkRequest = 
                            mSupplier.getExecutiveOrganisation().askUnion(t);
                        mSupplier.askUnionToSource(sourceMaterialWorkRequest);
                        JOptionPane.showMessageDialog(jSplitPane1, "Union was informed about Source Request");
                    }
                }),
        ...
        SourceRequest =  new DisplayTable<SourceMaterialWorkRequest>(
                mExecutiveOrg.getmSourceMaterialRequests().getList(),
                "Material Requested",
