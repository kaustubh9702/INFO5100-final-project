...
public class UnionPanel extends javax.swing.JPanel {
    ...
    UnionOrganisation mUnionOrganisation;
    UserAccount mAccount;
    
    Colors color;
    public UnionPanel(Controller cont,Organization org,UserAccount account, Enterprise ent) {
        
        mEcosystem = cont.getmEcoSystem();
        this.mSupplier =   (SupplierEnterprise) ent;
        mUnionOrganisation = this.mSupplier.getUnionOrganisation();
    ...
    private void initComponents() {
        ...
        iconButton3 = new IconButton("purchaser.png", "Info");
        iconButton1 = new IconButton("request.png", "Material Req");
        iconButton2 = new IconButton("union_32px.png", "Source Request");
    ...
    private void iconButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton1MousePressed
        ...
        changeWorkContainerPanel(SourceRequest);
    ...
    private void iconButton2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton2MousePressed
        ...
        changeWorkContainerPanel(PrevRequest);
    ...
    private void iconButton3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton3MousePressed
        ...
        changeWorkContainerPanel(new UserAccountPanel(mAccount, mSupplier, mUnionOrganisation, false));
    ...
    public DisplayTable SourceRequest;
    public DisplayTable PrevRequest;
    ...
    public void loadPanels(){
        ...
        SourceRequest =  new DisplayTable<SourceMaterialWorkRequest>(
            mUnionOrganisation.getmSourceMaterialWorkRequests().filter(WorkRequest.Status.PENDING),
                "Incoming Source Requests",
                 Arrays.asList( null,
                new ElementButton<SourceMaterialWorkRequest>("Deliver", "deliver.png", new ActionInterface<SourceMaterialWorkRequest>() {
                    @Override
                    public void action(SourceMaterialWorkRequest t) {
                        if(isNullThenShout(t)) return;
                        
                        
                        mController.getmMainFrame().getAddress((from) -> {
                            mController.getmMainFrame().getAddress((to) -> {
                                Shipment s = mSupplier.getUnionOrganisation().createShipment(t, from, to);
                                mEcosystem.getmLogisitics().shipOffGround(s, t);
                                JOptionPane.showMessageDialog(UnionPanel.this, "Shipment will be created");
                            });
                        });
                        
                    }
                }),
                new ElementButton<SourceMaterialWorkRequest>("Reject", "cancel.png", new ActionInterface<SourceMaterialWorkRequest>() {
                    @Override
                    public void action(SourceMaterialWorkRequest c) {
                        if(isNullThenShout(c)) return;
                        c.setStatus(WorkRequest.Status.REJECTED);
                    }
                })
              ),
        ...
        PrevRequest =  new DisplayTable<SourceMaterialWorkRequest>(
                mUnionOrganisation.getmSourceMaterialWorkRequests()
                        .filter((wr) -> !wr.status().equals(WorkRequest.Status.PENDING)),
                "Prev Requests",
