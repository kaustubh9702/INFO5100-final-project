 ...
 * @author Krishica
 */
public class OnGroundPanel extends javax.swing.JPanel {
    ...
    OnGroundDeliveryOrg mOnGroundDeliveryOrg;
    UserAccount mAccount;
    
    Colors color;
    public OnGroundPanel(Controller cont,Organization org,UserAccount account, Enterprise ent) {
        
        mEcosystem = cont.getmEcoSystem();
        this.mLogistics =    (LogisticsEnterprise) ent;
        mOnGroundDeliveryOrg = this.mLogistics.getOnGroundDeliveryOrg();
    ...
    private void initComponents() {
        ...
        iconButton1 = new IconButton("car.png", "Pending Deliveries");
        iconButton2 = new IconButton("time.png", "Prev Deliveries");
        ...
        workContainerPanel.setBackground(Colors.BACKGROUND);
    ...
    private void iconButton3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton3MousePressed
        ...
        changeWorkContainerPanel(new UserAccountPanel(mAccount, mLogistics, mOnGroundDeliveryOrg, false));
    ...
    public void loadPanels(){
        ...
        DeliveryRequests =  new DisplayTable<OnGroundWorkRequest>(
            mOnGroundDeliveryOrg.getRequests().filter(WorkRequest.Status.PENDING),
                "Delivery Requests",
                 Arrays.asList( 
                
               null,
                new ElementButton<OnGroundWorkRequest>("Done", "tick.png", new ActionInterface<OnGroundWorkRequest>() {
                    @Override
                    public void action(OnGroundWorkRequest t) {
                        if(isNullThenShout(t)) return;
                        
                        mOnGroundDeliveryOrg.deliveryDone(t, mAccount);
                        JOptionPane.showMessageDialog(OnGroundPanel.this, "Delivery Done");
        ...
        PrevRequest =  new DisplayTable<OnGroundWorkRequest>(
                mOnGroundDeliveryOrg.getRequests()
