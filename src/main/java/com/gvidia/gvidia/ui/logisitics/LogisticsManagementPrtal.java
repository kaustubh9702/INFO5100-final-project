 ...
 * @author Krishica
 */
public class LogisticsManagementPrtal extends javax.swing.JPanel {
    ...
    Colors color;
    public LogisticsManagementPrtal(Controller cont,Employee emp) {
        
        mEcosystem = cont.getmEcoSystem();
        this.mLogistics = mEcosystem.getmLogisitics();
    ...
    private void initComponents() {
        ...
        iconButton1 = new IconButton("car.png", "On Ground");
        iconButton2 = new IconButton("plane.png", "Off Ground");
    ...
    private void iconButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton1MousePressed
        ...
        changeWorkContainerPanel(OnGroundTable);
    ...
    private void iconButton2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton2MousePressed
        ...
        changeWorkContainerPanel(OffGroundTable);
    ...
    private void iconButton3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton3MousePressed
        ...
        try {
            changeWorkContainerPanel(new AnalysisPanel(mLogistics.getInsights()));
        } catch (IOException ex) {
            Logger.getLogger(LogisticsManagementPrtal.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public DisplayTable OnGroundTable;
    public DisplayTable OffGroundTable;
    ...
    public void loadPanels(){
        ...
        OnGroundTable =  new DisplayTable<UserAccount>(
            mEcosystem.getUserAccountDirectory().fliter(OnGroundDeliveryOrg.class.toString()),
                "Executives",
                 Arrays.asList(new ElementButton<UserAccount>("Create", "create.png", new ActionInterface<UserAccount>() {
                    ...
                    public void action(UserAccount t) {
                            changeWorkContainerPanel(new UserAccountPanel(null,mLogistics,mLogistics.getOnGroundDeliveryOrg(), true));                
                    }
                }),
                new ElementButton<UserAccount>("Edit", "edit.png", new ActionInterface<UserAccount>() {
                    @Override
                    public void action(UserAccount t) {
                        changeWorkContainerPanel(new UserAccountPanel(t,mLogistics,mLogistics.getOnGroundDeliveryOrg(), false));
                    }
                }),
        ...
        OffGroundTable =  new DisplayTable<UserAccount>(
            mEcosystem.getUserAccountDirectory().fliter(OffGroundDeliveryOrg.class.toString()),
                "Customers",
                 Arrays.asList(new ElementButton<UserAccount>("Create", "create.png", new ActionInterface<UserAccount>() {
                    @Override
                    public void action(UserAccount t) {
                        
                        changeWorkContainerPanel(new UserAccountPanel(t,mLogistics,mLogistics.getOffGroundDeliveryOrg(), false));
