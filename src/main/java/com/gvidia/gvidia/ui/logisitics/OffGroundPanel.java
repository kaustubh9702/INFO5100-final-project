 ...
 * @author MyPC1
 */
public class OffGroundPanel extends javax.swing.JPanel {
    ...
    OffGroundDeliveryOrg mOffGroundDeliveryOrg;
    UserAccount mAccount;
    
    Colors color;
    public OffGroundPanel(Controller cont,Organization org,UserAccount account, Enterprise ent) {
        
        mEcosystem = cont.getmEcoSystem();
        this.mLogistics =    (LogisticsEnterprise) ent;
        mOffGroundDeliveryOrg = this.mLogistics.getOffGroundDeliveryOrg();
        color = mLogistics.getThemeColor();
        initComponents();
    ...
    private void initComponents() {
        ...
        iconButton3 = new IconButton("customer.png", "Info");
        iconButton1 = new IconButton("plane.png", "Pending Delivery");
        iconButton2 = new IconButton("time.png", "Prev Delivery");
    ...
    private void iconButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton1MousePressed
        ...
        changeWorkContainerPanel(DeliveryRequests);
    ...
    private void iconButton3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconButton3MousePressed
        ...
        changeWorkContainerPanel(new UserAccountPanel(mAccount, mLogistics, mOffGroundDeliveryOrg, false));
    ...
    public DisplayTable DeliveryRequests;
    ...
    public void loadPanels(){
        ...
        DeliveryRequests =  new DisplayTable<OffGroundWorkRequest>(
            mOffGroundDeliveryOrg.getRequests().filter(WorkRequest.Status.PENDING),
                "Delivery Requests",
                 Arrays.asList(new ElementButton<OffGroundWorkRequest>("Route", "route.png", new ActionInterface<OffGroundWorkRequest>() {
                    @Override
                    public void action(OffGroundWorkRequest t) {
                        if(isNullThenShout(t)) return;
              
                    }
                }),
                new ElementButton<OffGroundWorkRequest>("Done", "tick.png", new ActionInterface<OffGroundWorkRequest>() {
                    @Override
                    public void action(OffGroundWorkRequest t) {
                        if(isNullThenShout(t)) return;
                        
                        mOffGroundDeliveryOrg.deliveryDone(t, mAccount);
                        JOptionPane.showMessageDialog(OffGroundPanel.this, "Delivery Done");
              ...
              mLogistics.getThemeColor()
        );
              
        PrevRequest =  new DisplayTable<OffGroundWorkRequest>(
                mOffGroundDeliveryOrg.getRequests()
